...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/winter-cherry-968b)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/winter-cherry-968b
```

A live public deployment of this template is available at [https://winter-cherry-968b.templates.workers.dev](https://winter-cherry-968b.templates.workers.dev)
